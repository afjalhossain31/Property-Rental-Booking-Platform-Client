...
export default function CustomerReviews() {
  ...
  return (
    <section className="relative overflow-hidden border-t border-slate-100 bg-slate-50 py-12 lg:py-20">
      <div className="absolute right-1/4 top-10 h-60 w-60 rounded-full bg-cyan-400/10 blur-3xl" />
      <div className="absolute bottom-12 left-1/4 h-60 w-60 rounded-full bg-blue-400/10 blur-3xl" />
